...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          Musa Malik - Software engineer, photographer, and student.
        </title>
        <meta
          name="description"
          content="I'm Musa, a software engineer and student based in Seattle, Washington. I'm currently an intern at Katanemo where I build fine-grained authorization systems."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I&apos;m Musa, a software engineer and student at Raisbeck Aviation High School based in Seattle, Washington. I&apos;m currently an intern at Katanemo where I build fine-grained authorization systems and maintain numerous tasks. I'm also the Founder/CEO of Gaari.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://instagram.com/musa.m.malik"
              aria-label="Follow on Instagram"
              icon={InstagramIcon}
            />
            <SocialLink
              href="https://github.com/Spherrrical"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/musa-malik-8b21aa218/"
